...
if(isset($_POST['submit'])){
  ...
  try{
    ...
    $mail->addAddress('mayank.raj0811@gmail.com'); // Email address where you want to receive emails (you can use any of your gmail address including the gmail address which you used as SMTP server)
